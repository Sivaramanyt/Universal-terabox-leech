...
class Config:
    ...
    # Other Settings - YOUR ORIGINAL COOKIE WITH PROPER CLOSING
...
class TeraboxBot:
    ...
    async def start(self):
        ...
        # Register handlers - NO HANDLE_PAYMENT HERE (that was the bug!)
    ...
    async def handle_callbacks(self, event):
        try:
            ...
            if data == "stats":
                ...
                await event.edit("❌ **Payment cancelled.**\\n\\nUse /buy to create a new payment request.")
...
if __name__ == "__main__":
    ...
    bot = TeraboxBot()
    try:
        logger.info("🚀 Starting Ultimate Terabox Bot with configurable shortlinks...")
